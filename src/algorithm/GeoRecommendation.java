...
public class GeoRecommendation {
	//content-based filtering with less users using the item content(category) to determine,
	//not using collaborative filtering (using both user and item to recommend)
